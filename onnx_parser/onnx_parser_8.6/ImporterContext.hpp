...
public:
    ...
    void registerLayer(nvinfer1::ILayer* layer, std::string const& basename, ::onnx::NodeProto const* node) override;
    void registerLayer(nvinfer1::ILayer* layer, ::onnx::NodeProto const& node) override;
    ...
    virtual void addUsedVCPluginLibrary(
        ::onnx::NodeProto const& node, char const* pluginName, char const* pluginLib) final;
