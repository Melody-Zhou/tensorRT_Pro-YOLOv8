...
namespace Yolo{
    ...
    public:
        ...
        virtual bool startup(
            ...
            if(type == Type::V5 || type == Type::V3 || type == Type::V7 || type == Type::V8 || type == Type::V6 || type == Type::V9 || type == Type::V10 || type == Type::V11){
        ...
        virtual void worker(promise<bool>& result) override{
            ...
            int num_classes    = (type_ == Type::V6 || type_ == Type::V8 || type_ == Type::V9 || type_ == Type::V10 || type_ == Type::V11) ? output->size(2) - 4 : output->size(2) - 5;
